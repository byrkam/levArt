public class Discount_Room extends Standard_Room{
    private double discount_per_day;
    public Discount_Room(int discount_per_day, double price_per_day, int room_capacity, double price_per_person){
