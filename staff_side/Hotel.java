...
public class Hotel implements Serializable{
    ...
    public void incomes(int room_number){
        ...
        JOptionPane.showMessageDialog(null,"The invoice for this room is: " + price, "Reservation", JOptionPane.PLAIN_MESSAGE);
    }
    public void incomes(){
        double price = 0;
        for(Room room : rooms){
        ...
        JOptionPane.showMessageDialog(null, "The total invoice is: " + price, "Reservation", JOptionPane.PLAIN_MESSAGE);
    }
